...
\paragraph{Reasoning moves.} Reaching a good $\sigma$ involves several
recognisable kinds of move on $C$ and $P$. \emph{Identifying ethically
relevant properties} of a situation precedes the formation of any
commitment about it. \emph{Proposing a principle} is an inductive or
abductive move from commitments to a candidate justifier. \emph{Deducing}
the commitments a principle implies in fresh situations is the downward
complement of proposal. Distinct from these are the moves a reasoner makes
once both sides are in play and conflict appears: \emph{commitment
revision} in light of a principle, \emph{principle revision} in light of a
commitment. The dialectical alternation of these last two is the move at
the heart of reflective equilibrium \citep{rawls1971,beisbart2021}, and it
is what gives that strategy its name. We make the strategy explicit in
...
without succeeding, walking away without escalation.
...
isolate each primitive (principle proposal, principle deduction, coherence
checking) and evaluate it independently of the strategy it is embedded in.
